...
local TEMP_CHANGE_RATE = 1.80                 -- Global modifier for how fast skin temperature changes
...
local TEMP_COOL_RATE = 13.0                   -- Modifier for how fast temperature cools down related to ENV_TEMP
local TEMP_COOL_VEL_RATE = 0.25                -- Modifier for how much velocity influences cooling skin
local DEFORMATION_ENERGY_MULTIPLIER = 0.05
local TORQUE_ENERGY_MULTIPLIER = 0.06         -- Modifier for how much energy is generated by torque and braking
