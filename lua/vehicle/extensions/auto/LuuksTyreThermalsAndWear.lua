...
local TEMP_CHANGE_RATE = 1.00                 -- Global modifier for how fast skin temperature changes
local TEMP_WORK_GAIN_RATE = 1.6                    -- Modifier for how fast temperature rises from wheel load e.i. generating G's
local TEMP_SLIP_GAIN_RATE = 1.4               -- 
local TEMP_COOL_RATE = 38.0                   -- Modifier for how fast temperature cools down related to ENV_TEMP
...
local function RecalcTyreWear(dt, wheelID, groundModel, loadBias, treadCoef, slipEnergy, propulsionTorque, brakeTorque,
    ...
    for i = 1, 3 do
        ...
        + ((0.003 * slipEnergy^2 * loadCoeffIndividual) * TEMP_SLIP_GAIN_RATE
