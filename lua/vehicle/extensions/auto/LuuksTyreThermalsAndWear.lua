...
local TEMP_WORK_GAIN_RATE = 2.5              -- Modifier for how fast temperature rises from wheel load e.i. generating G's
local TEMP_SLIP_GAIN_RATE = 1.4              --
local TEMP_COOL_RATE = 58.0                  -- Modifier for how fast temperature cools down related to ENV_TEMP
...
local TORQUE_ENERGY_MULTIPLIER = 0.15       -- Modifier for how much energy is generated by torque and braking
...
local function CalcTyreWear(dt, wheelID, groundModel, loadBias, treadCoef, slipEnergy, propulsionTorque, brakeTorque,
    ...
    for i = 1, 3 do
        ...
        local relative_work = math.abs(g_table.gx) * weights[i]
        ...
        + 0.15 * relative_work * TEMP_WORK_GAIN_RATE / (1 + slipEnergy ^ 2)) * groundModel.staticFrictionCoefficient)
