...
local TEMP_WORK_GAIN_RATE = 1.2              -- Modifier for how fast temperature rises from wheel side loading e.i. generating G's
local TEMP_SLIP_GAIN_RATE = 1.4              --
local TEMP_COOL_RATE = 85.0                  -- Modifier for how fast temperature cools down related to ENV_TEMP
