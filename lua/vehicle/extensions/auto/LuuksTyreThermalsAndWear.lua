...
local TEMP_COOL_RATE = 108.0                  -- Modifier for how fast temperature cools down related to ENV_TEMP
...
local TORQUE_ENERGY_MULTIPLIER = 0.05       -- Modifier for how much energy is generated by torque and braking
...
local function CalcTyreWear(dt, wheelID, groundModel, loadBias, treadCoef, slipEnergy, propulsionTorque, brakeTorque,
    ...
    for i = 1, 3 do
        ...
        + 0.05 * relative_work * TEMP_WORK_GAIN_RATE) * groundModel.staticFrictionCoefficient)
