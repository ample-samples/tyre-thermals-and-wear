...
local TEMP_COOL_RATE = 0.5                   -- Modifier for how fast temperature cools down related to ENV_TEMP
...
local function CalcTyreWear(dt, wheelID, groundModel, loadBias, treadCoef, slipEnergy, propulsionTorque, brakeTorque,
    ...
    local coreTempCooling = (data.temp[4] - ENV_TEMP) *
        (0.08 * CORE_TEMP_VEL_COOL_RATE * math.sqrt(airspeed) + 0.05 * CORE_TEMP_COOL_RATE) * lerp(0.8, 1, brake_coolingSetting / 12)
