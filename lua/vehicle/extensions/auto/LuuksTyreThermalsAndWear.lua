...
local TEMP_COOL_RATE = 22.0                   -- Modifier for how fast temperature cools down related to ENV_TEMP
...
local function CalcBiasWeights(loadBias)
    ...
    local weightLeft = -0.7*loadBias + 1
    local weightRight = 0.7*loadBias + 1
